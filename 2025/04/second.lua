        ...
        for index_column, column in ipairs(row) do
            if column == "@" then
                ...
                for i = 1, 3 do
                    ...
                    if y > 0 and y <= #row then
                        for j = 1, 3 do
                            ...
                            checked_x, checked_y = index_column, index_row
                            dprint("x = " .. x)
                ...
                if surrounding_paper_rolls < 4 then
                    password = password + 1
                    content_tbl[checked_y][checked_x] = "."
                    did_remove = true
                    break
                end
            end
